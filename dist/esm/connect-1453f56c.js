...
import { c as connectIcon } from './onboard-84493676.js';
import 'bignumber.js';
import 'bnc-sdk';
import 'bowser';
          ...
          switch (_context.prev = _context.next) {
            ...
            case 5:
              ...
              return _context.abrupt("return", {
                ...
                description: description || "PoolTogether requires access to your wallet, please login and authorize access to your ".concat(wallet.name, " account to continue."),
                eventCode: 'loginFail',
