...
export const mobileWalletInstallMessage = (helpers: {
  ...
  <p style="font-size: 0.889rem;">
    Tap the button below to <b>Open or Install ${selectedWallet}</b>. Click below to open UbikFinance with ${selectedWallet}'s in-app browser for a seamless experience.
  </p>
  `
}
